            ...
            <div className="border-b bg-white">
                <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
                    <nav className="flex flex-wrap items-center gap-2 text-sm text-gray-500">
                        ...
                        <a href="/imoveis" className="transition-colors hover:text-[#1e3a5f]">
                            Imóveis
                        </a>
                        <span className="text-gray-300">/</span>
                    ...
                    <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                        ...
                        <div className="rounded-xl bg-gradient-to-br from-[#1e3a5f] to-[#2d4a6f] p-6 text-white lg:min-w-[280px]">
                            ...
                            <p className="mt-1 text-3xl font-bold">
                                {formatPrice(price)}
                                {isRent && <span className="text-lg font-normal opacity-80">/mês</span>}
                            </p>
                    ...
                    <div className="space-y-6 lg:col-span-2">
                        ...
                        <div className="rounded-xl bg-white p-6 shadow-sm">
                            ...
                            <div className="mt-8 border-t pt-6">
                                <h3 className="mb-4 font-semibold text-gray-900">Comodidades</h3>
                        ...
                        <div className="sticky top-24 space-y-6">
                            ...
                            <div className="rounded-xl bg-white p-6 shadow-sm">
                                ...
                                <p className="mb-4 text-sm text-gray-600">
                                    Quer conhecer este imóvel pessoalmente? Agende uma visita com um de nossos corretores.
                                </p>
                                <a
                                    href={whatsappUrl}
                                    target="_blank"

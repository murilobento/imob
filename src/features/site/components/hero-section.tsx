    ...
    <section className='relative min-h-[600px] w-full'>
      ...
      <div className='relative mx-auto flex min-h-[600px] max-w-7xl flex-col justify-center px-4 py-20 sm:px-6 lg:px-8'>
        <div className='max-w-2xl'>
          <p className='mb-4 text-sm font-medium tracking-wider text-[#3b82f6] uppercase'>
          ...
          <div className='grid gap-4 sm:grid-cols-2 md:grid-cols-4'>
            ...
            <div>
              ...
              <div className='relative'>
                <select
                  ...
                  className='w-full appearance-none rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 pr-10 text-sm focus:border-[#3b82f6] focus:ring-1 focus:ring-[#3b82f6] focus:outline-none'
                >
            ...
            <div className='sm:col-span-2'>
              ...
              <input
                ...
                className='w-full rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm focus:border-[#3b82f6] focus:ring-1 focus:ring-[#3b82f6] focus:outline-none'
              />
            </div>

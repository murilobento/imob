...
const propertyTypes = ['HOUSE', 'APARTMENT', 'LAND', 'COMMERCIAL', 'RURAL'] as const
        ...
        <div className={cn('rounded-xl bg-white p-6 shadow-sm', className)}>
            ...
            <div className="relative mb-6">
                ...
                <input
                    ...
                    className="w-full rounded-lg border border-gray-200 bg-gray-50 py-2.5 pl-10 pr-4 text-sm focus:border-[#3b82f6] focus:outline-none focus:ring-1 focus:ring-[#3b82f6]"
                />
            </div>
            ...
            <div className="mb-6">
                ...
                <div className="flex gap-2">
                    <input
                        ...
                        className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm focus:border-[#3b82f6] focus:outline-none focus:ring-1 focus:ring-[#3b82f6]"
                    />
                    <input
                        type="number"
                        placeholder="Máximo"

      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-12 text-center'>
          ...
          <p className='mx-auto max-w-3xl text-gray-600'>
            Somos uma imobiliária comprometida em transformar sonhos em
            realidade. Com anos de experiência no mercado imobiliário de{' '}
            {cidade} e região, oferecemos um atendimento personalizado e
            transparente, guiando nossos clientes em cada etapa da jornada de
            compra, venda ou locação de imóveis. Mais do que uma imobiliária,
            somos parceiros na realização do seu sonho.
          </p>
        </div>

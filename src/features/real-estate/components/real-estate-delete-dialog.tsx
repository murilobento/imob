...
export function RealEstateDeleteDialog({ open, onOpenChange, currentRow }: Props) {
        ...
        <ConfirmDialog
            ...
            desc={
                <div className='space-y-4'>
                    <p className='mb-2'>
                        Tem certeza que deseja excluir <span className='font-bold'>{currentRow.title}</span>?
                        <br />

...
import { realEstateFinalities, realEstateStatuses, realEstateTypes } from '../data/data'
                        ...
                        <PopoverContent className="w-[300px] max-w-[90vw] p-4" align="end">
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <h4 className="font-medium leading-none">Faixa de Preço (Venda)</h4>
                                ...
                                <div className="pt-2">
                                    ...
                                    <div className="flex items-center justify-between mt-2">
                                        <span className="text-xs border px-2 py-1 rounded">{formatCurrency(priceRange[0])}</span>
                                        <span className="text-xs border px-2 py-1 rounded">{formatCurrency(priceRange[1])}</span>
                                    </div>
                                </div>
                            </div>
                        </PopoverContent>

            ...
            <div className='flex items-start gap-3'>
              ...
              <div className='min-w-0 flex-1 space-y-2'>
                ...
                <div className='grid grid-cols-2 gap-2 text-sm'>
                  {(realEstate.finality === 'SALE' ||
                    realEstate.finality === 'BOTH') && (
                    <div className='flex flex-col'>
                      <span className='text-muted-foreground text-[10px]'>
                        Venda
                      </span>
                      <span className='font-medium'>
                        {realEstate.sale_value
                          ? formatCurrency(realEstate.sale_value)
                          : '-'}
                      </span>
                    </div>
                  )}
                  {(realEstate.finality === 'RENT' ||
                    realEstate.finality === 'BOTH') && (
                    <div className='flex flex-col'>
                      <span className='text-muted-foreground text-[10px]'>
                        Locação
                      ...
                      <span className='font-medium'>
                        {realEstate.rental_value
                          ? formatCurrency(realEstate.rental_value)
                          : '-'}
                      </span>
                    </div>
                  )}
